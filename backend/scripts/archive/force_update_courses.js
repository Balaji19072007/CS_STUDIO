...
const pythonCourseData = {
    ...
    phases: [
        ...
        },
        {
            ...
            topics: ["Python Lists", "Access Items", "Change Items", "Add Items", "Remove Items", "Loop Lists", "List Comprehension", "Sort Lists", "Copy Lists", "Join Lists", "List Methods", "Python Tuples", "Access Tuples", "Update Tuples", "Unpack Tuples", "Loop Tuples", "Join Tuples", "Tuple Methods", "Python Sets", "Access Set Items", "Add Set Items", "Remove Set Items", "Loop Sets", "Join Sets", "Frozenset", "Set Methods", "Python Dictionaries", "Access Items", "Change Items", "Add Items", "Remove Items", "Loop Dictionaries", "Copy Dictionaries", "Nested Dictionaries", "Dictionary Methods"]
        },
        {
            phaseNumber: 8,
            title: "Functions",
...
async function forceUpdateCourse(courseData) {
    ...
    // 1. CLEANUP: Delete existing Phases/Topics systematically
    console.log(`  🧹 Cleaning up existing data...`);
    // Ideally we list subcollections, but client SDK can't.
    // We assume standard structure "phase-N" for N=1..30 (safe upper bound)
    for (let p = 1; p <= 30; p++) {
        const phaseId = `phase-${p}`;
        // Delete topics subcollection for this phase
        await deleteCollection(['courses', courseData.courseId, 'phases', phaseId, 'topics']);
        // Delete the phase doc itself? 
        // We can't batch delete specific doc using collection logic simply, 
        // but we can just overwrite or explicit delete. 
        // Explicit delete is safer to remove "ghost" phase fields.
        // But simply overwriting correct phases and ignoring others is "okay" IF we didn't have ghost phases.
        // Better: Delete the phase doc too.
        // However, deleteCollection works on COLLECTIONS. Phase docs are in 'phases' collection.
    }
