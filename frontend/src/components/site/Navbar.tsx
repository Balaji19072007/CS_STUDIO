      ...
      >
        <div className="glass-strong shadow-glass flex items-center justify-between rounded-full px-5 py-3">
          ...
          <div className="flex flex-1 items-center justify-end gap-2">
            ...
            <div className="flex items-center gap-1 rounded-full p-1 border border-border/50">
              {isLoggedIn ? (
                <Link to="/problems" className="rounded-full bg-gradient-to-r from-primary to-accent px-5 py-2 text-sm font-medium text-primary-foreground shadow-glow transition hover:opacity-90">
                  Dashboard
                </Link>
              ) : (
                <>
                  <Link to="/signin" className="px-4 py-2 text-sm font-medium text-muted-foreground hover:text-foreground transition">Sign in</Link>
