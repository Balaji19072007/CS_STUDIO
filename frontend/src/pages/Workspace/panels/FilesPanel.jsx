...
const FilesPanel = ({ files, setFiles, activeFile, setActiveFile }) => {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      >
        <span className="text-[10px] font-bold uppercase tracking-widest flex-1" style={{ color: 'rgba(255,255,255,0.35)' }}>
          Files
        </span>
        ...
        {files.length === 0 ? (
          ...
          files.map(file => (
            <button
              ...
              onMouseEnter={e => { if (activeFile !== file.name) e.currentTarget.style.background = 'rgba(255,255,255,0.05)'; }}
      ...
      {contextMenu && (
        <div
          ...
          style={{ ...CTX_STYLE, top: contextMenu.y, left: contextMenu.x }}
