...
const CodeEditorTab = () => {
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden relative bg-white dark:bg-[#060B14]">
      
      {/* Top action bar specifically for Code Editor tab */}
      <div className="flex items-center justify-between p-3 border-b border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-[#0A1122]">
